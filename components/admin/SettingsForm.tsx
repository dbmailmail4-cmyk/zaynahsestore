    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-5xl pb-16">
      ...
      {activeTab === 'navigation' && (
        <NavigationTab
          ...
          editingMenuItemState={editingMenuItemState}
        />
      )}
      ...
      {activeTab === 'premium' && (
        <PremiumTab
          ...
          setSocialFeedsProductEnabled={setSocialFeedsProductEnabled}
          socialFeedsTitle={socialFeedsTitle}
          setSocialFeedsTitle={setSocialFeedsTitle}
          socialFeedsSubtitle={socialFeedsSubtitle}
          setSocialFeedsSubtitle={setSocialFeedsSubtitle}
          socialFeedsDesc={socialFeedsDesc}
          setSocialFeedsDesc={setSocialFeedsDesc}
          socialFeedsItems={socialFeedsItems}
          setSocialFeedsItems={setSocialFeedsItems}
          tempFeedUsername={tempFeedUsername}
          setTempFeedUsername={setTempFeedUsername}
          tempFeedLink={tempFeedLink}
          setTempFeedLink={setTempFeedLink}
          tempFeedImageUrl={tempFeedImageUrl}
          setTempFeedImageUrl={setTempFeedImageUrl}
